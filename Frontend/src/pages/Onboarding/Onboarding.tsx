        ...
        <div className={styles.heroInner}>
          <div>
            ...
            <p className={styles.heroSub}>
              ...
              connect farmers, buyers, and sellers through intelligent
              technology that grows your business and eliminates waste.
            </p>
          ...
          <div className={styles.heroCard}>
            ...
            <p className={styles.heroCardBody}>
              ...
              enhance productivity, sustainability, and efficiency — shaping the
        ...
        <div className={styles.howInner}>
          <div>
            ...
            <p className={styles.howSubText}>
              Our platform connects quality produce directly with buyers — top
              quality, zero waste, fully transparent.
            </p>
            ...
            {[
              {
                ...
                desc: "Sign up as a Farmer, Buyer, or Seller. Each role gets a tailored dashboard built for your exact workflow.",
              },
              {
                n: "02",
                title: "Input Produce or Demand",
                desc: "Farmers log crop type, soil type, and location. Buyers and sellers enter what they need or have available.",
              },
              {
                n: "03",
                title: "AI Matches & Schedules",
                desc: "Our AI engine instantly matches buyers to available produce and predicts the optimal harvest window.",
              },
              {
                n: "04",
                title: "Get Notified & Deliver",
                desc: "Receive SMS and email alerts for every match. Track deliveries in real time from your dashboard.",
              },
            ].map(({ n, title, desc }) => (
            ...
            {[
              {
                ...
                cssClass: styles.rp1,
                name: "Farmers",
                tagline: "Grow & Manage Produce",
              },
              {
                key: "role_buyer",
                cssClass: styles.rp2,
                name: "Buyers",
                tagline: "Source Quality Produce",
              },
              {
                key: "role_seller",
                cssClass: styles.rp3,
                name: "Sellers",
                tagline: "List & Sell Availability",
              },
